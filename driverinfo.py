...
#0 equals reserve driver for FP session
def fp_points(x, list):
    print("Enter FP finishing positions for", str(list[x][0]))
    fp1, fp2, fp3 = input("").split()
    y = list[x].extend([fp1, fp2, fp3])
    return y
